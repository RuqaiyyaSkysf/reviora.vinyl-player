...
export function Tonearm() {
  ...
  const themeColors: Record<string, {
    ...
    "desert-moon": {
      arm: "from-green-300 via-green-400 to-green-500",
      armHighlight: "rgba(132,204,22,0.3)",
      base: "from-green-700 to-green-800",
      baseHighlight: "from-green-600 to-green-700",
      head: "from-green-200 to-green-400",
      needle: "from-green-100 to-green-300",
      needleGlow: "rgba(132,204,22,0.5)",
      shadow: "rgba(0,0,0,0.5)",
    },
  }
